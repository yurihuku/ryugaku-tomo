      ...
      <div class="flex-1/2">
        ...
        <div class="reactions flex justify-center gap-2.5 pt-4">
          <div class="like_reaction">
            ...
            <div class="flex h-16 w-16 items-center justify-center rounded-xl border"><ion-icon name="heart" class="like-btn cursor-pointer text-pink-500" id="{{$post->id}}_like"></ion-icon></div>
            @else
          ...
          <div class="support_reaction">
            ...
            <div class="flex h-16 w-16 items-center justify-center rounded-xl border"><ion-icon name="flame" class="support-btn cursor-pointer text-pink-500" id="{{$post->id}}_support"></ion-icon></div>
            @else
